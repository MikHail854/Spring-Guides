...
public class RelationalDataAccessApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        log.info("Querying for customer records where firstName = 'Jeff':");
        jdbcTemplate.query("SELECT id, firstName, lastName FROM customers WHERE firstName = ?", new Object[]{"Jeff"},
